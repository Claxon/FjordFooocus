...
class FooocusExpansion:
    def __init__(self):
        ...
        print(f'FjordFooocus V2 Expansion: Vocab with {len(debug_list)} words.')
        ...
        print(f'FjordFooocus Expansion engine loaded for {load_device}, use_fp16 = {use_fp16}.')
    ...
    def __call__(self, prompt, seed):
        ...
        if self.patcher.current_device != self.patcher.load_device:
            print('FjordFooocus Expansion loaded by itself.')
